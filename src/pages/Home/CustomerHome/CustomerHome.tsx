...
import { getAllCustomerPayments, getCustomerFactors, getProducts } from '../../../Utils/FirebaseTools'
...
const CustomerHome: React.FC = () => {
    ...
    useEffect(() => {
        ...
        getAllCustomerPayments(authentication.originalEntityId)
            .then(pays => {
    ...
    const saleActivity = () => {
        ...
        let priceDataSet: DoughnutDataSet = {
            backgroundColor: [],
            data: [],
            label: t('theAmountOfMoneyPurchase')
        }
        let numberDataSet: DoughnutDataSet = {
            backgroundColor: [],
            data: [],
            label: t('totalNumberOFPurchasedProduct')
        }
    ...
    return (
        <div className='input'>
            <h1 className='title'>{t('purchasesStatistics')}</h1>
            <div className='display_flex margin_top_20 flex_flow_wrap flex_direction_column justify_content_center full_width'>
                <div className='display_flex flex_flow_wrap justify_content_space_around'>
                    <div className='card_box data_card_info margin_5'>
                        <div>{t('theAmountOfMoneyPurchase')}</div>
                ...
                <div className=' full_width justify_content_space_around display_flex flex_flow_wrap margin_top_10' >
                    <div className='chart_container input margin_top_10'>
                        <p className='title_2 '>{t('theAmountOfMoneyPurchase')}</p>
                        {productsSales ?
                    ...
                    <div className=' chart_container input margin_top_10'>
                        <p className='title_2'>{t('totalNumberOFPurchasedProduct')}</p>
                        {productsNumber ?
