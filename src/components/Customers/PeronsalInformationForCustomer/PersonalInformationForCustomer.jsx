...
function PersonalInformationForCustomer() {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const data = await getDoc(doc(db, Collections.Customers, authentication.originalEntityId));
                if (data.exists()) {
...
export default PersonalInformationForCustomer